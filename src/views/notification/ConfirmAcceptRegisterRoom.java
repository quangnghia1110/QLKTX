 ...
 * @author ADMIN
 */
public class ConfirmAcceptRegisterRoom extends javax.swing.JDialog {
    private Student st;
    /**
     * Creates new form approveMoveAnotherRoom
     */
    public ConfirmAcceptRegisterRoom() {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("đăng kí vào phòng này không ?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConfirmAcceptRegisterRoom.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConfirmAcceptRegisterRoom dialog = new ConfirmAcceptRegisterRoom();
