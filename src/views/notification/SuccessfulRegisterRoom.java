 ...
 * @author ADMIN
 */
public class SuccessfulRegisterRoom extends javax.swing.JDialog {

    /**
     * Creates new form seccessfulRegisterRoom
     */
    public SuccessfulRegisterRoom(java.awt.Frame parent, boolean modal, String tilte, String tilte_2) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(null);
        
        jLabel4.setText(tilte);
        jLabel4.setHorizontalAlignment(SwingConstants.CENTER);
        if(tilte_2 != null){
            jLabel5.setText(tilte_2);
    ...
    private SuccessfulRegisterRoom(JFrame jFrame, boolean b) {
    ...
    private void initComponents() {
        ...
        jTextArea1.setText("   Yêu cầu của bạn đang được xét duyệt\n                       Vui lòng chờ !");
        ...
        panelRound3.setPreferredSize(new java.awt.Dimension(80, 42));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SuccessfulRegisterRoom.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                SuccessfulRegisterRoom dialog = new SuccessfulRegisterRoom(new javax.swing.JFrame(), true);
