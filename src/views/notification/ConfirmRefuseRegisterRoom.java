 ...
 * @author ADMIN
 */
public class ConfirmRefuseRegisterRoom extends javax.swing.JDialog {
    private Student st;
    /**
     * Creates new form approveMoveAnotherRoom
     */
    public ConfirmRefuseRegisterRoom() {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Bạn sẽ hủy đăng kí phòng của");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConfirmRefuseRegisterRoom.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConfirmRefuseRegisterRoom dialog = new ConfirmRefuseRegisterRoom();
