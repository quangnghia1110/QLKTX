 ...
 * @author ADMIN
 */
public class FailedLogIn extends javax.swing.JDialog {

    /**
     * Creates new form failedLogIn
     */
    
    public FailedLogIn(java.awt.Dialog parent, boolean modal) {
        super(parent, modal);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Tên đăng nhập hoặc mật khẩu không chính xác");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FailedLogIn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FailedLogIn dialog = new FailedLogIn(new javax.swing.JDialog(), true);
