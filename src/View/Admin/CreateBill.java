...
import View.Admin.RoomList.*;
import java.awt.Color;
import Model.Room;
import Dao.RoomDAO;

public class CreateBill extends javax.swing.JDialog {
   

    // Modify the constructor to accept the roomList reference
    public CreateBill(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            CreateBill dialog = new CreateBill(new javax.swing.JFrame(), true); // Pass the reference
